...
const fcsbodyArr = [`{"num":1}`], fcshdArr = [{"Content-Type":"application/json; charset=UTF-8","Accept":"application/json","Authorization":"Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJkYXRhIjp7Il9pZCI6IjYwYTExZTk5ZjRiMmZjMDc3Y2I4ZTljYiIsInRva2VuVHlwZSI6IndlYkNsaWVudCJ9LCJleHAiOjE2MjYzNTU4NjUsImlhdCI6MTYyMTE3MTg2NX0.1xgm9F_q5unuKZZqgFRDmhOvLnz-dDtiVdGxKQOFSYM","credentials":"include","Host":"api.rtree.org","Accept-Language":"zh-CN","Client-Referer-Origin":"wealth","Accept-Encoding":"br, gzip, deflate","Origin":"https://rtree.org","Content-Length":"9","User-Agent":"Mozilla/5.0 (iPad; CPU OS 12_5_2 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/12.1.2 Mobile/15E148 Safari/604.1","Referer":"https://rtree.org/?ref=UDJJXL7SYF","Connection":"keep-alive"}],fcsurlArr = [`https://api.rtree.org/api/v1/tree/water`],fcscount = '1'
