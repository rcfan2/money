...
let count=0;
let token="eyJhbGciOiJIUzUxMiJ9..o_1oTwZIg9HYEu9zktJOTeLfb4xC1hXQh7dlg9ce-341qZOhcFrUPap2IMvV9zHQMyJVCw0VTw60jT5l0CdazQ"
let phoneNum;
let Code;
let mid;
let waitcount;
...
function readbook(i) {
  ...
  const body = "_public=skinId%253D999%2526idfa%253D6A512375-6547-48CF-AB48-A08D67EC8D30%2526ustatus%253D1%2526first_placeid%253D111111%2526net_env%253Dwifi%2526umidtoken%253DYDPsPb4aPtoDABChU4koVzch%2526user_id%253D2007250779%2526sn%253D53A46A81755F81591615BBDED9CE4FD2C8028827%2526placeid%253D111111%2526msv%253D8.0.0%2526brand%253DApple%2526imei%253D771CF1BA9AE3A901BB47B19918D5BC5656A1B37A%2526skinVersionPrefix%253D1%2526appVer%253D4.3.4.0%2526skinActiveColor%253D0F9970%2526manufacturer%253DApple%2526session%253DeyJhbGciOiJIUzUxMiJ9..o_1oTwZIg9HYEu9zktJOTeLfb4xC1hXQh7dlg9ce-341qZOhcFrUPap2IMvV9zHQMyJVCw0VTw60jT5l0CdazQ%2526skinColor%253D23B383%2526platform%253DiOS%2526ver%253D210207%2526mod%253DiPhoneXS%2526statusBarHeight%253D44.000000%2526skinVersion%253D1%2526wh%253D1125x2436%2526soft_id%253D21%2526utdid%253DYDPsPb4aPtoDABChU4koVzch%2526utype%253Dvip%2526sdk%253D13.5&key=sq_app_ad&platform=iOS&reqEncryptParam=%3A&reqEncryptType=-1&resEncryptType=-1&sign=7C27F749DC8342CB2176A9385A15D7EB&timestamp=1614019750&userId=2007250779 HTTP/1.1";
  const headers = {
